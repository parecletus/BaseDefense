...
public class PowerUp
{
    ...
    public void Start(GunEntity _gun)
    {
        ...
        powerlist.Add(new Powers("Bullet +1 damage -%30", UpdateGun4));
        ...
        for (int x = 0; x < numberOffBlocks; x++)
        {
            ...
            blocklist.Add(new Blocks(posX, posY, blockWidth, blockHeight, powerlist[yo].GetDo(), 
            powerlist[yo].Name));
            powerlist.Remove(powerlist[yo]);
        }
    }
    ...
    public void UpdateGun4() => gun.GunUpgrade(_bulletcount: 1, percentBulletDmg:0.7f);
    ...
    public void Draw()
    {
        ...
        Raylib.DrawRectangle(0,20,(int)windowsetting.windowsize.X,50, Color.Gray);
